...
public abstract class Effect {
    ...
    public int getScoreChange(int playerID) {
        ...
        try {
            ...
            log.warn("scoreChange must be an integer number not " + scoreChange + ".");
            return 0;
        }
    }
    ...
    public int getCounter(int idx) {
        ...
        try {
            ...
            log.warn("counter must be an integer number not " + counter + ".");
            return 0;
        }
    }
    ...
    public int getCounterElse(int idx) {
        ...
        try {
            ...
            log.warn("counterElse must be an integer number not " + counterElse + ".");
            return 0;
        }
    }
