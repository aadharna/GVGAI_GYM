...
class SerializableStateObservation:
     ...
     * GVGAI-JavaClient.qmul.gvgai.server.serialization.SerializableStateObservation
    """
    def __init__(self):
...
class Observation:
    """
     * Serialized state observation, corresponding to the Java Client code:
     * GVGAI-JavaClient.qmul.gvgai.server.serialization.Observation
    """
...
class Vector2d:
    """
     * Serialized state observation, corresponding to the Java Client code:
     * GVGAI-JavaClient.qmul.gvgai.server.serialization.Vector2d
    """
